...
def GetBackGround_new(data, pObjMap, nWidth, nHeight, certain_value, spatial_threshold):
    return _RSUtilityTool.GetBackGround_new(data, pObjMap, nWidth, nHeight, certain_value, spatial_threshold)

def GetRegion_mask(data, mask, nWidth, nHeight, certain_value, spatial_threshold):
    return _RSUtilityTool.GetRegion_mask(data, mask, nWidth, nHeight, certain_value, spatial_threshold)
